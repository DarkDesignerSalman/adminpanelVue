<template>
  <v-app-bar app elevate-on-scroll elevation="3" color="white">
    ...
    <v-spacer />
    <v-col lg="4" cols="12" class="m-0">
      <v-btn color="blue" outlined rounded small shaped>Shortcuts</v-btn>
    </v-col>
    <v-col lg="4" cols="12">
      <v-btn
        icon
      ...
      >
      <span style="color:blue;"> {{ textItems[currentIndex] }}</span>
      <v-btn
        icon
        outlined
    ...
    <v-menu offset-y lg="4" cols="12">
      <template v-slot:activator="{ attrs, on }">
        <span
          ...
          v-on="on"
        >
          <v-icon color="blue" class="pr-1">mdi-content-save-outline</v-icon>
